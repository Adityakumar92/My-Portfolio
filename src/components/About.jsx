    ...
    >
      <div>
        ...
        <div className="mt-2">
          ...
          <div>
            <ul>
              <li className="bg-green-100 mt-1">Spearheaded the design and development of a robust admin web portal, leveraging HTML, CSS, and JavaScript to deliver a seamless user experience.</li>
              <li className="bg-green-100 mt-1">Implemented cutting-edge authentication and authorization mechanisms, ensuring secure user verification and role based redirection to tailored dashboards.</li>
              <li className="bg-green-100 mt-1">Crafted a dynamic, data-driven admin dashboard, showcasing key performance metrics, including active user count, admin placement, and real-time analytics.</li>
              <li className="bg-green-100 mt-1">Developed a fully responsive, mobile-first website, utilizing CSS media queries, flexible grids, and JavaScript event listeners to ensure a consistent, intuitive interface across devices.</li>
            </ul>
          </div>
        </div>
        <br />
        ...
        <div className="mt-2">
          ...
          <div>
            <ul>
              <li className="bg-green-100 mt-1">Lead acquring sponsorship from multiple local and national brands, thus enchancing the quality of fest.</li>
              <li className="bg-green-100 mt-1">Devised optimal 'PublicityPoint' for for maximizing the sponsors reach in offline and online events in JAGRITI'23.</li>
            </ul>
          </div>
        </div>
        <br />

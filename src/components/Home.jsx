...
import pic from "../../public/photo2.jpg";
            ...
            <div className="flex flex-col items-center md:flex-row justify-between space-y-6 md:space-y-0">
              <div className="  space-y-2">
                ...
                <ul className="flex space-x-5">
                  <li>
                    <a href="https://github.com/Adityakumar92" target="_blank">
                      <FaGithub className="text-2xl cursor-pointer" />
                    </a>
                  </li>
                  <li>
                    <a href="https://www.linkedin.com/in/aditya-kumar-2b4660246" target="_blank">
                      <FaLinkedin className="text-2xl cursor-pointer" />
                    </a>
                  </li>
                  <li>
                    <a href="https://codeforces.com/profile/Little_Aditya" target="_blank">
                      <SiCodeforces className="text-2xl cursor-pointer" />
                    </a>
                  </li>
                  <li>
                    <a href="https://leetcode.com/u/Little_Aditya/" target="_blank">
